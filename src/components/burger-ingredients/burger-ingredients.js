...
// const IngredientsList = ({ title, ingredientsList, onIngredientClick }) => {
...
//                 {current === 'bun' && (
//                     <>
//                         <IngredientsList title="Булки" ingredientsList={buns} onIngredientClick={onAddIngredient} />
//                         <IngredientsList title="Соусы" ingredientsList={sauces} onIngredientClick={onAddIngredient} />
//                         <IngredientsList title="Начинки" ingredientsList={mains} onIngredientClick={onAddIngredient} />
//                     </>
//                 )
//                 }
//                 {current === 'sauce' && <IngredientsList title="Соусы" ingredientsList={sauces} onIngredientClick={onAddIngredient} />}
//                 {current === 'main' && <IngredientsList title="Начинки" ingredientsList={mains} onIngredientClick={onAddIngredient} />}
//             </div>
//         </section>
